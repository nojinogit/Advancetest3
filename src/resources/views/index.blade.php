            ...
            <table class="main__form--table">
                        ...
                        <td>
                            <div id="input-name">
                                <div class="input-name-item">
                                    <input name="name1" value="{{old('name1')}}">
                                    <p>例）山田</p>
                                    @if($errors->has('name1'))
                                ...
                                <div class="input-name-item">
                                    <input name="name2" value="{{old('name2')}}">
                                    <p>例）太郎</p>
                                    @if($errors->has('name2'))
                ...
                <div>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input  class="main__form--table-input"  name="email" value="{{old('email')}}">
                            </div>
                        </td>
                    </tr>
                </div>
                ...
                <div>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input class="main__form--table-input" name="postcode" value="{{old('postcode')}}" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');">
                            </div>
                        </td>
                    </tr>
                </div>
                ...
                <div>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input class="main__form--table-input" name="address" value="{{old('address')}}">
                            </div>
                        </td>
                    </tr>
                </div>
                ...
                <div>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input class="main__form--table-input" name="building_name" value="{{old('building_name')}}">
                            </div>
                        </td>
                    </tr>
                </div>
